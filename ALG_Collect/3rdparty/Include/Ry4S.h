...
#define ERR_SET_DES_KEY                 40 // Set DES Key Error
#define ERR_DES_ENCRYPT                 41 // DES Encryption Error 
#define ERR_DES_DECRYPT                 42 // DES Decryption Error 
#define ERR_SET_RSAKEY_N                43 // Error in writing N into RSA keypair
#define ERR_SET_RSAKEY_D                44 // Error in writing D into RSA keypair
#define ERR_RSA_ENCRYPT                 45 // RSA Encryption Error 
#define ERR_RSA_DECRYPT                 46 // RSA Decryption Error
#define ERR_INVALID_LENGTH              47 // Illegal length of data

#define R4SERR_JUST_TIMER											 0x32 //error when check time 
#define R4SERR_NO_SUCH_DEVICE							             0xA1 //find no such device
#define R4SERR_NOT_OPENED_DEVICE						             0xA2 //RY_Open demand
#define R4SERR_WRONG_UID								             0xA3 //error of UID
#define R4SERR_INDEX									             0xA4 //The block index error given by the read and write operations
#define R4SERR_TOO_LONG_SEED							             0xA5 //the length of seed is bigger than 64 bytes
#define R4SERR_WRITE_PROTECT							             0xA6 //Tries to rewrite the write-protected device
#define R4SERR_OPEN_DEVICE								             0xA7 //Error of Windows
#define R4SERR_READ_REPORT								             0xA8 //Error of Windows
#define R4SERR_WRITE_REPORT											 0xA9 //Error of Windows
#define R4SERR_SETUP_DI_GET_DEVICE_INTERFACE_DETAIL	                 0xAA //Error of Windows
#define R4SERR_GET_ATTRIBUTES							             0xAB //Error of Windows
#define R4SERR_GET_PREPARSED_DATA						             0xAC //Error of Windows
#define R4SERR_GETCAPS									             0xAD //Error of Windows
#define R4SERR_FREE_PREPARSED_DATA						             0xAE //Error of Windows
#define R4SERR_FLUSH_QUEUE								             0xAF //Error of Windows
#define R4SERR_SETUP_DI_CLASS_DEVS						             0xB0 //Error of Windows
#define R4SERR_GET_SERIAL								             0xB1 //Error of Windows
#define R4SERR_GET_PRODUCT_STRING						             0xB2 //Error of Windows
#define R4SERR_TOO_LONG_DEVICE_DETAIL					             0xB3 //Internal error
#define R4SERR_UNKNOWN_DEVICE							             0xB4 //Unknown device
#define R4SERR_VERIFY									             0xB5 //Validation error
#define R4SERR_ERASE									             0xB6 //Erase error of Hardware 
#define	RY4SERR_INVALID_RY4S							             0xB7 //NO Rockey4Smart
#define R4SERR_UNKNOWN_ERROR							             0xFF //Unknown error

#define ERR_UPFILE_CRC	                                             0xC0 //Check fails with CRC when updating
#define	ERR_UPFILE_UID	                                             0xC1 //Check fails with UID when updating
#define ERR_UPFILE_HID	                                             0xC2 //Check fails with HID when updating
#define ERR_UPFILE_MOD	                                             0xC3 //Mod Invalid
#define	ERR_UPFILE_DATE                                              0xC4 //Excess of the authorized date
#define ERR_UPDATE		                                             0xC5 //Update fails
#define ERR_UPDATE_OVERFLOW		                                     0xC6 //Boundary overflow
#define ERR_UPDATE_UNKNOWN_CMD	                                     0xC7 //Unknown update items
#define ERR_UPDATE_INVALID	                        	             0xC8 //upgrade package is invalid

#define ERR_ACTIVATION                                               0xE0 //Activation fails
#define ERROR_PASSWORD	                                             0xE1 //Error password
#define ERROR_DESCENDING_IS_NOT_ALLOWED                              0xE2 //Disable to decrease
#define ERROR_WITHOUT_DUE_AUTHORITY                                  0xE3 //No response permission
#define ERROR_COUNT_MODULE_ISZERO                                    0xE4 //Module is zero
#define ERROR_CHANGE_PWD                                             0xE5 //Error login password
#define ERR_INDEX		                                             0xE6 //The index of unit is Wrong
#define ERR_AUTH_TYPE	                                             0xE7 //Error License Type
#define ERR_AUTH_VIRGIN                                              0xE8 //Unit uninitialized
#define ERR_AUTH_EXPIRED                                             0xE9 //License has expired
#define	ERR_RSA			                                             0xEA //RSA error
#define R4S_ERR_UNKNOWN                                              0xEB //Unknown error in Dongle
#define R4S_ERR_ADDR                                                 0xEC //Error Address
